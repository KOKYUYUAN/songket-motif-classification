"""
Training script for Songket motif classifier using AlexNet.
...
# 6. TRAINING LOOP
print(f"🚀 Training AlexNet started on {device}...")
...
# 7. SAVE YOUR MODEL
torch.save(model.state_dict(), "songket_motif_alexnet_final.pth")
print("✅ Training Complete. Model saved as 'songket_motif_alexnet_final.pth'")
