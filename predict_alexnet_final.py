"""
Prediction script for Songket motif inference using AlexNet.
Loads 'songket_motif_alexnet_final.pth' and predicts motif for test images.
"""
...
# Preprocess for AlexNet / ImageNet-pretrained models
...
def load_trained_model(model_path: str):
    """Load AlexNet weights and replace the classifier for Songket classes."""
...
if __name__ == "__main__":
    ...
    if os.path.exists(MODEL_FILE):
        ...
        print(f"❌ Error: {MODEL_FILE} not found. Did you run train_alexnet_final.py?")
