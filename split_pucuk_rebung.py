"""Split pucuk_rebung images into train/val (80/20)."""
...
def main() -> None:
    ...
    source_path = project_root / "raw_data" / "pucuk_rebung"
    train_path = project_root / "dataset" / "train" / "pucuk_rebung"
    val_path = project_root / "dataset" / "val" / "pucuk_rebung"
