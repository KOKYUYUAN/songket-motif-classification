"""
Prediction script for Songket motif inference using ResNet50.
Loads 'songket_motif_resnet50_final.pth' and predicts motif for test images.
"""
...
if __name__ == "__main__":
    ...
    if os.path.exists(MODEL_FILE):
        ...
        print(f"❌ Error: {MODEL_FILE} not found. Did you run train_resnet50_final.py?")
