...
def process_all_folders(root_dir, tile_size=224, stride=150):
    ...
    for split in ['train', 'val', 'test']:
        ...
        for motif_folder in target_motifs:
            ...
            # Check if the folder exists for this motif
            if not os.path.exists(input_folder):
                print(f"❌ Missing folder: {input_folder}. Please create it!")
                continue
...
if __name__ == "__main__":
    process_all_folders("dataset/final_split")
    print("\n🎉 All target motifs tiled successfully for train, val, and test sets!")
